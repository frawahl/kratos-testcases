...
#if !defined(KRATOS_SPLIT_EXTENSION_CONSTRAINT_UTILITIES )
#define  KRATOS_Y_SPLIT_EXTENSION_CONSTRAINT_UTILITIES
...
class SplitExtensionConstraintProcess : public Process
{
public:
    ...
    /// Pointer definition of SplitExtensionConstraintProcess
    KRATOS_CLASS_POINTER_DEFINITION(SplitExtensionConstraintProcess);

    ///@}
    ///@name Life Cycle
    ///@{

    SplitExtensionConstraintProcess(
        Model& rModel,
    ...
    /// Destructor.
    virtual ~SplitExtensionConstraintProcess() = default;
    ...
    {
        return "SplitExtensionConstraintProcess";
    }

    /// Print information about this object.
    virtual void PrintInfo(std::ostream& rOStream) const override
    {
        rOStream << "SplitExtensionConstraintProcess";
    }
...
private:
    ...
    /// Assignment operator.
    // SplitExtensionConstraintProcess& operator=(SplitExtensionConstraintProcess const& rOther);

    /// Copy constructor.
    //SplitExtensionConstraintProcess(SplitExtensionConstraintProcess const& rOther);

    ///@}

}; // Class SplitExtensionConstraintProcess

} // namespace Kratos.

#endif // KRATOS_SPLIT_EXTENSION_CONSTRAINT_UTILITIES  defined
